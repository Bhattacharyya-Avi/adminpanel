...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('backend/image/apple-icon.png')}}" />
    <link rel="icon" type="image/png" href="{{asset('backend/image/favicon.png')}}" />
    ...
    <!-- Main Styling -->
    <link href="{{asset('backend/css/soft-ui-dashboard-tailwind.css')}}" rel="stylesheet" />    
  </head>
  ...
  <script src="{{asset('backend/js/perfect-scrollbar.min.js')}}" async></script>
  <!-- github button -->
