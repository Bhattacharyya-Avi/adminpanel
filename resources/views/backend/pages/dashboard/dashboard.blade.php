                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                            <div class="h-full bg-gradient-to-tl from-purple-700 to-pink-500 rounded-xl">
                                <img src="{{asset('backend/image/shapes/waves-white.svg')}}"
                                    class="absolute top-0 hidden w-1/2 h-full lg:block" alt="waves" />
                                <div class="relative flex items-center justify-center h-full">
                                    <img class="relative z-20 w-full pt-6"
                                        src="{{asset('backend/image/illustrations/rocket-white.png')}}" alt="rocket" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                    style="background-image: url('{{asset('backend/image/ivancik.jpg')}}')">
                    <span
                    ...
                    <div
                        ...
                        <div class="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-sm text-slate-700">$2400, Design changes
                                </h6>
                        ...
                        <div class="relative mb-4 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-sm text-slate-700">Server payments for
                                    April</h6>
                        ...
                        <div class="relative mb-4 after:clear-both after:table after:content-['']">
                            ...
                            <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                <h6 class="mb-0 font-semibold leading-normal text-sm text-slate-700">Unlock packages for
                                    development</h6>
